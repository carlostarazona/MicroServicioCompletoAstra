package pe.edu.upc.hospitalservice.cucumber;
...
import pe.edu.upc.hospitalservice.HospitalServiceApplication;
...
@SpringBootTest(classes = HospitalServiceApplication.class, webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT)
